export const CardFood = () => {
  return (
    <div className="lg:gap[2rem] grid grid-cols-[1.3fr_0.7fr] grid-rows-[1fr_1fr_1fr] gap-[3vw] rounded-[5px] bg-primary-grey-900 py-3 px-4 text-center shadow-01 md:grid-cols-[1fr_6rem_6rem__7.5rem] md:grid-rows-[auto] xl:gap-[2rem]">
      <p className="col-start-1 row-start-2 my-auto text-left text-subheading-02 font-bold md:col-start-1 md:row-start-1 md:text-paragraph-01 md:font-normal ">
        Pan con pollo 247g
      </p>
      <p className="col-start-2 row-span-2 row-start-2 my-auto text-right text-subheading-01 font-bold md:col-start-2 md:row-span-1 md:row-start-1 md:text-center md:text-paragraph-01 md:font-normal">
        460 Kcal
      </p>
