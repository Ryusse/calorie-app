...
export const Sidebar = ({ className }) => {
  return (
    <aside
      className={`relative sticky top-0 z-30  hidden h-screen flex-col border-r border-primary-grey-600 bg-primary-grey-900 py-6 after:absolute after:top-0 after:left-0 
