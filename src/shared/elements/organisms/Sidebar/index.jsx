...
export const Sidebar = ({ className }) => {
  return (
    <aside
      className={`relative sticky top-0 hidden h-screen flex-col bg-primary-grey-900 py-14 shadow-01 after:absolute after:top-0 
                  after:left-0 after:h-screen after:w-[100vw] after:translate-x-[-100%] after:bg-primary-grey-900 after:content-[''] lg:col-span-2 lg:flex ${className}`}
    >
